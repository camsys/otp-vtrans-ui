...
var RequestView = Backbone.View.extend({
  ...
  initialize: function (options) {
    ...
    this.listenTo(this.model, 'change', function (data) {
      ...
      if (data.attributes.useDemandResponse) {
        view.$('#useDemandResponse').prop('checked', true)
      }
      if (data.attributes.banDemandResponse) {
        view.$('#banDemandResponse').prop('checked', true)
      }
      if (data.attributes.demandResponseReluctance) {
        view.$('#demandResponseReluctance').val(data.attributes.demandResponseReluctance)
      }
  ...
  render: function () {
    ...
    var showDemandResponsOptions = window.OTP_config.showDemandResponseOptions

    if (showDemandResponsOptions) {
      console.log('showing showDemandResponsOptions:==' + showDemandResponsOptions + '==')
      this.$('#hidableSettingsDemandResponsOptions').show()
    } else {
      console.log('HIDING showDemandResponsOptions:==' + showDemandResponsOptions + '==')
      this.$('#hidableSettingsDemandResponsOptions').hide()
    }
  ...
  changeForm: function (evt) {
    ...
    var data = {
      ...
      useDemandResponse: this.$('#useDemandResponse').prop('checked'),
      banDemandResponse: this.$('#banDemandResponse').prop('checked'),
      demandResponseReluctance: this.$('#demandResponseReluctance').val()
    }
