    ...
    if (leg.isWalk() || leg.isBicycle()) {
      ...
      if (leg.isFlagStopLeg() === true) {
        if (leg.isFromFlagStop() === true) {
          console.log('FROM IS A FLAG STOP')
          console.log(leg.getFromFlagStopArea())
          ...
          var fromArrow = L.polylineDecorator(fromStopLine).addTo(this.options.map)
              ...
              patterns: [
                { offset: '50%',
                  ...
                  symbol: L.Symbol.marker({
                    ...
                    markerOptions: {
                      icon: L.icon({
                        iconUrl: '../build/otpjs/lib/images/icon_plane.png',
                        iconAnchor: [10, 15]
                      })
                    }
                  })
                ...
                { offset: '0%',
                  ...
                  symbol: L.Symbol.marker({
                    ...
                    markerOptions: {
                      icon: L.icon({
                        iconUrl: '../build/otpjs/lib/images/left_arrow.png',
                        iconAnchor: [10, 10]
                      })
                    }
                  })
                ...
                { offset: '100%',
                  ...
                  symbol: L.Symbol.marker({
                    ...
                    markerOptions: {
                      icon: L.icon({
                        iconUrl: '../build/otpjs/lib/images/right_arrow.png',
                        iconAnchor: [10, 15]
                      })
                    }
                  })
        ...
        if (leg.isToFlagStop() === true) {
          console.log('TO IS A FLAG STOP!!!!!!!!!')
          console.log(leg.getToFlagStopArea())
