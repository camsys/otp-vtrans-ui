  ...
  initialize: function (options) {
    ...
    flagStopIconPattern = { offset: '50%',
      ...
      symbol: L.Symbol.marker({
        ...
        markerOptions: {
          icon: L.icon({
            iconUrl: 'build/otpjs/lib/images/waving_person.png',
            iconAnchor: [10, 15]
          })
        }
      })
    ...
    if (leg.isWalk() || leg.isBicycle()) {
      ...
      if (leg.isFlagStopLeg() === true) {
        ...
        if (leg.isFromFlagStop() === true) {
          ...
          fromStopLine.bindLabel(flagStopContent)
        ...
        if (leg.isFromDeviatedRoute() === true) {
          ...
          fromCurvedPath.bindLabel(deviatedRouteContent)
        ...
        if (leg.isToDeviatedRoute() === true) {
          ...
          toCurvedPath.bindLabel(deviatedRouteContent)
