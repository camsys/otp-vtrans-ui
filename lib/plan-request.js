...
var PlanRequest = Backbone.Model.extend({
  ...
  defaults: {
    ...
    useDemandResponse: window.OTP_config.useDemandResponseDefault,
    banDemandResponse: window.OTP_config.banDemandResponseDefault,
    demandResponseReluctance: window.OTP_config.demandResponseReluctance,
